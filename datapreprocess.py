...
# ==========================================
# Đọc file dữ liệu (đảm bảo file csv để cùng thư mục với code)
...
# ==========================================
# 💡 Best Practice: Luôn chia Train/Test TRƯỚC KHI chuẩn hóa để tránh rò rỉ dữ liệu (Data Leakage)
...
print(f"Số lượng khách hàng để Train (80%): {X_train_scaled.shape[0]} người")
print(f"Số lượng khách hàng để Test (20%): {X_test_scaled.shape[0]} người")
print("\nDữ liệu của khách hàng đầu tiên trong tập Train sau khi chuẩn hóa:")
